...
def create_cust(num):
    ...
    for i in range(0,num):
        data.append((fake.first_name(), fake.last_name(), fake.address(), int(round(random.random(), 2) * 100)))
    return data
...
cur.executemany("INSERT INTO customers (first_name, last_name, address, age) VALUES (?, ?, ?, ?)", customer_data)
